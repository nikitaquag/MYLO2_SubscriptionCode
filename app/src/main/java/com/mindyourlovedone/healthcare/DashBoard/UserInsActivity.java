...
if (From.equalsIgnoreCase("Profile")) {
    ...
    txtStep1.setText(Html.fromHtml("<b>The Profiles Screen.</b> The Profiles screen is home base. Users can set up as many profiles as they want. To access the functionality of MYLO click anywhere on the Profile cell; User’s will be brought to the Dashboard screen. (The file folder on the Profile cell represents the Dashboard.) "));
    txtStep2.setText(Html.fromHtml("<b>The Dashboard.</b> Within each Profile is a Dashboard. The Dashboard is where Users will input and store information, business cards and documents. There are 6 sections on the Dashboard and within each section are sub-sections. The main sections are (1) Personal, Medical and Emergency Contacts; (2) Specialty Contacts; (3) Notes and Appointments; (4) Advance Directives and Other Documents; (5) Insurance; and (6) Prescriptions. "));
    txtStep3.setText(Html.fromHtml("<b>User Instructions.</b>  Each section and sub-section have first-time user instructions as well as standing instructions. User instructions are available by clicking the question mark on the top right corner of the screen. To exit user instructions, click the arrow back button on the top right corner of the screen. To forward instructions click the up arrow on the right top corner of the screen.  The Menu Bar also contains how-to videos for many of the sections. "));
    txtStep4.setText(Html.fromHtml("<b>Create a new Profile.</b> To create a Profile for a loved one, click the green PLUS button located at the bottom right corner of the screen.  Users will be given a choice to “Create New or Import from Dropbox”.  Create New allows users to initiate a new profile. Users can automatically add data from their contacts, or type in new information.  The minimum amount of information you need to create a profile is the person’s name, the User’s relationship to the person, and their email address. To Access the Dashboard click anywhere on the profile cell."));
    txtStep5.setText(Html.fromHtml("<b>Import from Dropbox.</b>  This functionality is used when restoring a profile or uploading a profile that was shared by another person. Instructions regarding backup, restore, and sharing can be found in the Menu Bar under Settings. "));
    ...
    txtStep9.setText(Html.fromHtml("<b>The Menu bar.</b> The menu bar is available from the Profiles page and the Dashboard. It’s \n" +
            "located on the top left corner (the three horizontal lines). The menu bar is chockful of important information including MYLO FAQs, the User Guide and how to contact us. Please remember to take a look at the Resource section – it includes information about advance care directives, MYLO forms and templates, and interesting podcasts and videos. To exit the Menu click All Profiles. "));
    ...
    txtStep2.setText(Html.fromHtml("<b>User Instructions.</b> Each section and sub-section have first-time user instructions as well as standing instructions. User instructions are available by clicking the question mark on the top right corner of the screen. To exit the user instructions, click the arrow back button on the top right corner of the screen. To forward instructions click the up arrow on the right top corner of the screen. The Menu Bar also contains how-to videos for many of the sections. "));
    ...
    txtStep4.setText(Html.fromHtml("<b>The Menu Bar.</b> The menu bar is located on the top left corner of the Dashboard (it’s the three horizontal lines). The menu bar is chockful of important information including MYLO FAQs, User Guide and how to contact us. Please take a look at the Resource section – it includes information about advance care directives, MYLO forms and templates, and interesting podcasts and videos. To exit the Menu Bar click ALL PROFILES."));
