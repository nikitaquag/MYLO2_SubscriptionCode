...
public class PrescriptionUploadAdapter extends RecyclerSwipeAdapter<PrescriptionUploadAdapter.ViewHolder> {
    Context context;
    ...
    public PrescriptionUploadAdapter(Activity activity, ArrayList<Hospital> hospitalList, FragmentPrescriptionUpload fragmentPrescriptionInfo) {
...
//                .imageScaleType(ImageScaleType.EXACTLY_STRETCHED) // default
    ...
    @Override
    public PrescriptionUploadAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_pres_info, parent, false);
        return new PrescriptionUploadAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(final PrescriptionUploadAdapter.ViewHolder holder, final int position) {
