package com.mindyourlovedone.healthcare.customview;
...
public class MySpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        hintTextSize = getResources().getDimension(R.dimen.dimension20dp);
        ...
        isRtl = false;
        mHintView = android.R.layout.simple_spinner_item;
        mDropDownHintView = android.R.layout.simple_spinner_dropdown_item;
    ...
    public void setSelection(final int position) {
        this.post(new Runnable() {
            @Override
            public void run() {
                MySpinner.super.setSelection(position);
            }
        });
    }
    ...
    */
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            textView.setTextColor(MySpinner.this.isEnabled() ? hintColor : disabledColor);
